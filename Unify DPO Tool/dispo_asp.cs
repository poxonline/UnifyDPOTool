...
namespace Unify_DPO_Tool
{
    public partial class dispo_asp : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Möchten sie wirklich den Ansprechpartner \"" + ((asp)cb_list_asp.SelectedItem).prop_name + "\" löschen?", "Sind sie sicher?", MessageBoxButtons.YesNo);
